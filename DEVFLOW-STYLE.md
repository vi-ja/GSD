...
This document explains how DevFlow is written so future AI instances can contribute consistently.

## Core Philosophy

DevFlow is a **meta-prompting system** where every file is both implementation and specification. Files teach the AI how to build software systematically. The system optimizes for:
...
### Templates (`.devflow/templates/*.md`)

Reusable document structures. Copy, don't reference.

### References (`.devflow/examples/*.md`)
