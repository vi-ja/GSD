...
**PowerShell:**
```powershell
$totalPhases = (Select-String -Path ".devflow/ROADMAP.md" -Pattern "### Phase \d+").Count
...
**Bash:**
```bash
total_phases=$(grep -c "### Phase [0-9]" ".devflow/ROADMAP.md")
...
**Also update:**
- Phase directory names (`.devflow/phases/{N}/`)
