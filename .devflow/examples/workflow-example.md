# DevFlow Workflow Example

> A complete walkthrough of using DevFlow from start to finish.

## Scenario: Building a Simple Todo API

### Step 1: Define the Spec

First, fill out `.devflow/SPEC.md`:
...
This creates:
- `.devflow/ARCHITECTURE.md` — Current structure
- `.devflow/STACK.md` — Technologies in use
...
DevFlow analyzes the SPEC and creates `.devflow/phases/1/` with PLAN.md files:
...
*This example demonstrates the DevFlow methodology flow.*
